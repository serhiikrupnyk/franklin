export default function SectionHowLearning() {
  return (
    <section id="education" className="how-learning">
      ...
      />
      <div className="how-learning__overlay" />
      <div className="container how-learning__container">
        <h2 className="unbounded_70 how-learning__title" aria-label="Як проходить навчання">
          <span className="how-learning__title-top">ЯК ПРОХОДИТЬ</span>
          <span className="how-learning__title-bottom">НАВЧАННЯ:</span>
        </h2>

        <div className="how-learning__stage">
          <div className="how-learning__column">
            <div className="how-learning__card how-learning__card--white">
              <div className="how-learning__card-head">
                <span className="how-learning__badge" aria-hidden="true">
                  <svg className="how-learning__card-icon" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="how-learning__card how-learning__card--orange">
              <div className="how-learning__card-head">
                <span className="how-learning__badge" aria-hidden="true">
                  <svg className="how-learning__card-icon" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <div className="how-learning__card how-learning__card--white">
              ...
              <p className="how-learning__card-text">
                <span className="how-learning__card-accent">З досвідом 2+ роки,</span>{" "}
                які будуть завжди поряд, завжди допоможуть та підтримають.
              </p>
            </div>
          </div>
